...
def checkPyVer():
    ...
    if int(platform.python_version().split('.')[0]) < 3:
        ...
        logger.error('please install python::3')
        sys.exit()
...
def openUrl(host: str, port: int):
    """
    Listen and open the url after shirley is started
    :param host:
    :param port:
    :return:
    """
...
def main(host=_hostIP(), port=50003):
    ...
    try:
        ...
        logger.info('stop shirley system success')                   
